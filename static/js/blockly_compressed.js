...
Blockly.ZoomControls.prototype.createDom = function() {
    ...
    var aaa = Blockly.utils.createSvgElement("div", {
        width: 50 + 'px',
        height: 50 + 'px',
        background: '#555'
    }, this.svgGroup_);
...
Blockly.HorizontalFlyout.prototype.getMetrics_ = function() {
    ...
    return {
        viewHeight: d,
        viewWidth: this.width_ - 2 * this.SCROLLBAR_PADDING + 10,
